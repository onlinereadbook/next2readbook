(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-addons-css-transition-group', 'classnames', '../Buttons/Button'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-addons-css-transition-group'), require('classnames'), require('../Buttons/Button'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactAddonsCssTransitionGroup, global.classnames, global.Button);
    global.SpeedDial = mod.exports;
  }
})(this, function (exports, _react, _reactAddonsCssTransitionGroup, _classnames, _Button) {
  'use strict';
  ...
  SpeedDial.propTypes = {
    ...
    fabs: function fabs(props, propName, component) {
      ...
      if (size >= 3 && size <= 5) {
        ...
        return (_PropTypes$arrayOf = _react.PropTypes.arrayOf(_react.PropTypes.oneOfType([_react.PropTypes.node, _react.PropTypes.shape({
