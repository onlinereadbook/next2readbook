(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'classnames', 'react-prop-types/lib/deprecated', '../utils/PropTypes/componentDeprecated', '../Media/Media', '../Media/MediaOverlay'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../utils/PropTypes/componentDeprecated'), require('../Media/Media'), require('../Media/MediaOverlay'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.classnames, global.deprecated, global.componentDeprecated, global.Media, global.MediaOverlay);
    global.CardMedia = mod.exports;
  }
})(this, function (exports, _react, _classnames, _deprecated, _componentDeprecated, _Media, _MediaOverlay) {
  'use strict';
  ...
  CardMedia.propTypes = {
     ...
     */
    overlay: (0, _deprecated2.default)(_react.PropTypes.node, 'Use the `MediaOverlay` component as a child instead'),
