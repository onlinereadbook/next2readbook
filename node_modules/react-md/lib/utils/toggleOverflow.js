(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(mod.exports);
    global.toggleOverflow = mod.exports;
  }
  ...
  exports.default = toggleOverflow;
  /**
   ...
   */
  function toggleOverflow(visible, selector) {
    var className = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'md-overflow-hidden';
